...
export function QuoteSection() {
  ...
  return (
    <motion.section
      ...
      className="relative z-10 flex flex-col items-center gap-12 justify-center px-4 py-32 w-full max-w-4xl mx-auto text-center overflow-hidden after:absolute after:bottom-0 after:left-0 after:right-0 after:h-[2px] after:bg-linear-to-r after:from-transparent after:via-white/20 after:to-transparent"
    >
      {/* Pill */}
