...
const integrationIcons = [
  ...
  {
    label: "Pinterest-like",
    svg: (
      <svg viewBox="0 0 24 24" className="w-5 h-5 text-zinc-400" fill="currentColor">
        <path d="M12 2C6.48 2 2 6.48 2 12c0 4.24 2.65 7.86 6.39 9.29-.09-.78-.17-1.98.04-2.83.18-.77 1.22-5.15 1.22-5.15s-.31-.62-.31-1.54c0-1.44.84-2.52 1.88-2.52.88 0 1.31.66 1.31 1.46 0 .89-.57 2.23-.86 3.47-.24 1.03.51 1.88 1.52 1.88 1.82 0 3.04-2.34 3.04-5.12 0-2.11-1.42-3.69-3.99-3.69-2.9 0-4.72 2.17-4.72 4.6 0 .84.24 1.42.62 1.88.18.21.2.3.14.54-.04.18-.15.61-.19.78-.06.25-.25.34-.46.25-1.29-.53-1.89-1.96-1.89-3.56 0-2.64 2.23-5.84 6.64-5.84 3.56 0 5.91 2.58 5.91 5.35 0 3.67-2.04 6.43-5.02 6.43-.95 0-1.85-.51-2.16-1.09l-.59 2.27c-.19.72-.57 1.44-.9 2.01A10 10 0 0 0 22 12c0-5.52-4.48-10-10-10z"/>
      </svg>
    ),
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 24 24" className="w-5 h-5 text-zinc-400" fill="currentColor">
        <path d="M4 0h16v8h-8L4 0zm0 8h8l8 8H4V8zm0 8h8v8L4 16z"/>
      </svg>
    ),
  },
  {
  ...
  {
    label: "N",
    svg: <span className="text-zinc-400 font-bold font-serif text-lg">N</span>,
  },
  {
    label: "S",
    svg: (
    ...
    <>
      ...
      <section className="relative z-10 flex flex-col items-center justify-center px-4 py-20 w-full max-w-4xl mx-auto mt-10" id="integrations">
        ...
        <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-zinc-100 mb-4 text-center">
          Seamless <span className="font-serif italic font-light text-zinc-300">Integrations</span>
        </h2>
        <p className="text-zinc-400 mb-12 text-base text-center max-w-xl">
        ...
        <div className="w-full max-w-xl bg-[#0a0a0a] border border-white/5 rounded-3xl p-6 shadow-[0_0_40px_rgba(0,0,0,0.5)]">
          <div className="grid grid-cols-4 gap-y-6 gap-x-4">
            {integrationIcons.map((icon, i) => (
              <div
                key={i}
                className="flex items-center justify-center w-12 h-12 mx-auto bg-[#151515] border border-white/5 rounded-xl hover:border-white/10 hover:bg-zinc-800/40 transition-colors cursor-pointer"
              >
                {icon.svg}
              </div>
            ))}
      ...
      <section className="relative z-10 flex flex-col items-center justify-center px-4 py-20 w-full max-w-6xl mx-auto mt-10" id="reviews">
        ...
        {/* Heading */}
        <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-zinc-100 mb-4 text-center">
          Trusted by <span className="font-serif italic font-light text-zinc-300">Visionaries</span>
        </h2>
        <p className="text-zinc-400 mb-14 text-base text-center max-w-xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full mb-16">
          {testimonials.map((t, i) => (
            <div
              key={i}
              className="flex flex-col p-6 bg-[#0a0a0a] rounded-2xl border border-white/5 shadow-[0_0_30px_rgba(0,0,0,0.4)] hover:border-white/10 transition-colors"
            >
              {/* Avatar + Name */}
        ...
        <div className="flex flex-wrap items-center justify-center gap-8 md:gap-12 w-full border-t border-white/5 pt-10">
          {brands.map((brand, i) => (
            <span
              key={i}
              className={`text-zinc-500 font-semibold tracking-wide text-base hover:text-zinc-300 transition-colors cursor-pointer ${i % 2 === 0 ? "" : "underline underline-offset-4"}`}
            >
              {brand}
            </span>
          ))}
