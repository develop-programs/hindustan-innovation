...
export default function Testimonial() {
    ...
    return (
      ...
      bg-radial mx-auto mt-10 after:absolute after:bottom-0 after:left-0 after:right-0 after:h-[2px] after:bg-linear-to-r after:from-transparent after:via-white/20 after:to-transparent overflow-hidden" id="reviews">
            <motion.div
                initial="hidden"
                whileInView="visible"
            ...
            >
                {testimonials.reviews.map((t) => (
                    <motion.div variants={itemVariants} key={t.name} className="flex flex-col p-6 bg-black rounded-2xl border-t-2 border-white/25 outline outline-white/10 hover:border-white/10 transition-colors">
