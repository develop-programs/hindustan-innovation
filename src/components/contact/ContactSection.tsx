...
export function ContactSection() {
    ...
    return (
        <div className="relative min-h-screen after:absolute after:bottom-0 after:left-0 after:right-0 after:h-[2px] after:bg-linear-to-r after:from-transparent after:via-white/20 after:to-transparent overflow-hidden">
            <Navbar />
            <motion.section
            ...
            >
                ...
                <motion.p variants={itemVariants} className="text-zinc-400 mb-14 text-sm md:text-base text-center max-w-xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full text-left">
                    ...
                    <div className="flex flex-col gap-6">
                        {/* Email Card */}
                        <motion.div variants={itemVariants} className="flex flex-col p-8 bg-zinc-950/40 backdrop-blur-sm rounded-2xl border-t-2 border-white/25 outline outline-1 outline-white/5 hover:border-white/10 transition-colors shadow-2xl">
                            <div className="flex items-center gap-4 mb-4">
                                <div className="w-12 h-12 flex items-center justify-center rounded-xl bg-zinc-900 border border-white/10 shadow-inner shrink-0">
                                    <Mail className="w-5 h-5 text-zinc-300" />
                                </div>
                                <h3 className="text-lg font-semibold text-zinc-100">{contactPage.emailUs.title}</h3>
                            </div>
                            <p className="text-zinc-400 text-sm mb-6 leading-relaxed">
                                {contactPage.emailUs.description}
                            </p>
                            <a href={`mailto:${contactPage.emailUs.email}`} className="text-sm font-medium text-zinc-300 hover:text-white transition-colors underline underline-offset-4 decoration-white/20 hover:decoration-white/50 w-fit">
                        ...
                        <motion.div variants={itemVariants} className="flex flex-col p-8 bg-zinc-950/40 backdrop-blur-sm rounded-2xl border-t-2 border-white/25 outline outline-1 outline-white/5 hover:border-white/10 transition-colors shadow-2xl">
                            <div className="flex items-center gap-4 mb-4">
                                ...
                                <h3 className="text-lg font-semibold text-zinc-100">{contactPage.contactSales.title}</h3>
                            </div>
                            <p className="text-zinc-400 text-sm mb-6 leading-relaxed">
