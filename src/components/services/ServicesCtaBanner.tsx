...
export function ServicesCtaBanner() {
  return (
    <section className="relative z-10 w-full max-w-5xl mx-auto px-4 md:px-8 pb-24">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8 p-10 md:p-14">
          <div>
            ...
            <p className="text-zinc-400 max-w-lg">
              Book a free consultation call and our experts will help you choose
              the right solution for your business goals.
            </p>
          </div>
